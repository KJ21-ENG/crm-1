...
def execute():
    """Force update: set CRM Ticket Quick Entry layout with Ticket Owner in first column.

    This patch ensures the layout is updated even if earlier patches ran previously.
    """
    layout = (
