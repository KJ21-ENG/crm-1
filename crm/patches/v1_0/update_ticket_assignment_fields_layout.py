...
def execute():
    """Update CRM Ticket field layout to include new assignment fields"""
    ...
    # Define the updated layout with new assignment fields
    new_layout = [
        {
            "name": "details",
            "label": "Details",
    ...
    frappe.db.commit()
    print("✅ Updated CRM Ticket field layout with new assignment fields") 