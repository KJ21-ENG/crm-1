        ...
        for task in overdue_tasks:
            try:
                ...
                if not unassigned_users:
                    ...
                    frappe.logger().warning(f"All users for role {role_name} have been assigned to task {task.name}. Notifying admin.")
                    ...
                    try:
                        ...
                        admin_notification = create_task_notification(
                            ...
                            message=f"All eligible users have been assigned to task: {task_doc.title}",
                            reference_doctype=task_doc.reference_doctype,
                            reference_docname=task_doc.reference_docname
                        )
