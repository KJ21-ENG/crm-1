app_name = "crm"
app_title = "Eshin Broking CRM"
app_publisher = "Your Company Name"
app_description = "Customized CRM System for Eshin Broking Financial Services"
app_email = "dev@yourcompany.com"
app_license = "Proprietary - Eshin Broking Exclusive"
app_icon_url = "/assets/crm/images/logo.svg"
app_icon_title = "Eshin CRM"
app_icon_route = "/crm"
...
scheduler_events = {
	"cron": {
		...
		# Auto reassign overdue tasks every 5 minutes
		"*/5 * * * *": [
			"crm.api.task_reassignment.auto_reassign_overdue_tasks"
		]
	},
	"daily": [
