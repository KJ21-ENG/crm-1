    ...
    pages: [
      {
        ...
        content: [
          ...
          { type: "image", alt: "CRM Dashboard Overview", caption: "The main dashboard showing key metrics and navigation.", src: "" }
        ]
      },
      {
        id: "navigation",
    ...
    pages: [
      {
        ...
        content: [
          ...
          { type: "image", alt: "Prospect List View", caption: "List of active prospects with status filters.", src: "" },
          ...
          { type: "image", alt: "New Prospect Form", caption: "The creation form with mandatory fields highlighted.", src: "" }
        ]
      },
      {
        id: "assignment",
    ...
    pages: [
      {
        ...
        content: [
          ...
          { type: "image", alt: "Compliance Record Tab", caption: "The Compliance tab within a Prospect page.", src: "" },
          ...
          { type: "image", alt: "Document Upload Section", caption: "Uploading KYC documents.", src: "" }
        ]
      }
    ]
  },
    ...
    pages: [
      {
        ...
        content: [
          ...
          { type: "image", alt: "Client Account Overview", caption: "Client dashboard showing total portfolio value.", src: "" }
        ]
      }
    ]
  }
